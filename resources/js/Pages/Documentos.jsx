...
export default function Documentos() {
  const companyDocs = [
    { title: 'Contrato único de prestación de servicios', href: '/docs/contrato-unico-prestacion-servicios.pdf' },
    { title: 'Contrato único convergente de servicios fijos y móviles (pospago)', href: '/docs/contrato-unico-convergente-pospago.pdf' },
    { title: 'Carta de suspensión de contrato de servicios de internet', href: 'https://usc1.contabostorage.com/ec0270e0cc0b4fc6bf9c10fa0d981689:integra/fibernet/web/CARTA_DE_SUSPENSION_DEL_CONTRATO.pdf' },
    { title: 'Formato de cesión de derechos', href: '/docs/formato-cesion-de-derechos.docx' },
    { title: 'Formato de autorización de propietario', href: '/docs/formato-autorizacion-propietario.docx' },
    { title: 'Formato de solicitud de ampliación o cambio de plan', href: 'https://usc1.contabostorage.com/ec0270e0cc0b4fc6bf9c10fa0d981689:integra/fibernet/web/Formato_Cambio_de_Plan_SM_Telecomunicaciones.pdf' },
    { title: 'Procedimiento de solicitudes y PQRS', href: '/docs/procedimiento-solicitudes-pqrs.pdf' },
    { title: 'Política de neutralidad en internet', href: '/docs/politica-neutralidad-internet.pdf' },
    { title: 'Autorización para el tratamiento de datos personales', href: 'https://usc1.contabostorage.com/ec0270e0cc0b4fc6bf9c10fa0d981689:integra/fibernet/web/FORMATO_AUTORIZACION_DE_DATOS.pdf' },
    { title: 'Política de facturación, recaudo, suspensión y reconexión del servicio', href: '/docs/politica-facturacion-recaudo-suspension.pdf' },
    { title: 'Política de protección de datos personales', href: 'https://usc1.contabostorage.com/ec0270e0cc0b4fc6bf9c10fa0d981689:integra/fibernet/web/POLÍTICA_DE_PROTECCIÓN_Y_TRATAMIENTO_DE_DATOS_PERSONALES.pdf' },
    { title: 'Guía de acuerdo de nivel de servicio (SLA)', href: '/docs/guia-acuerdo-nivel-servicio-sla.pdf' },
    { title: 'Protocolo de seguridad de la información', href: '/docs/protocolo-seguridad-informacion.pdf' },
    { title: 'Sistema de políticas y gestión de seguridad de la información', href: 'https://usc1.contabostorage.com/ec0270e0cc0b4fc6bf9c10fa0d981689:integra/fibernet/web/SISTEMA_DE_POLÍTICAS_Y_GESTIÓN_DE_SEGURIDAD_DE_LA_INFORMACIÓN_RESOLUCIÓN_CRC_5050_DE_2016_Y_RESOLUCIÓN_CRC_5569_DE_2018.pdf' },
    { title: 'Acciones para la gestión de tráfico del usuario', href: 'https://usc1.contabostorage.com/ec0270e0cc0b4fc6bf9c10fa0d981689:integra/fibernet/web/ACCIONES_PARA_LA_GESTIÓN_DE_TRAFICO_DEL_USUARIO.pdf' },
    { title: 'Guía de seguridad en la red para usuarios', href: '/docs/guia-seguridad-red-usuarios.pdf' },
    { title: 'Control parental', href: 'https://usc1.contabostorage.com/ec0270e0cc0b4fc6bf9c10fa0d981689:integra/fibernet/web/CONTROL_PARENTAL.pdf' },
    { title: 'Sistema de políticas y gestión de seguridad de la red', href: '/docs/sistema-politicas-seguridad-red.pdf' },
    { title: 'Condiciones de calidad del servicio de internet', href: 'https://usc1.contabostorage.com/ec0270e0cc0b4fc6bf9c10fa0d981689:integra/fibernet/web/CONDICIONES_DE_CALIDAD_DE_LOS_SERVICIOS_OFRECIDOS_POR_SM_OPTICAL_FIBER_S.pdf' },
  ];
