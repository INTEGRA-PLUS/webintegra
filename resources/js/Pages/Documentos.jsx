...
export default function Documentos() {
  const companyDocs = [
    { title: 'Contrato único de prestación de servicios', href: null },
    { title: 'Contrato único convergente de servicios fijos y móviles (pospago)', href: null },
    { title: 'Carta de suspensión de contrato de servicios de internet', href: null },
    { title: 'Formato de cesión de derechos', href: null },
    { title: 'Formato de autorización de propietario', href: null },
    { title: 'Formato de solicitud de ampliación o cambio de plan', href: null },
    { title: 'Procedimiento de solicitudes y PQRS', href: null },
    { title: 'Política de neutralidad en internet', href: null },
    { title: 'Autorización para el tratamiento de datos personales', href: null },
    { title: 'Política de facturación, recaudo, suspensión y reconexión del servicio', href: null },
    { title: 'Política de protección de datos personales', href: null },
    { title: 'Guía de acuerdo de nivel de servicio (SLA)', href: null },
    { title: 'Protocolo de seguridad de la información', href: null },
    { title: 'Sistema de políticas y gestión de seguridad de la información', href: null },
    { title: 'Acciones para la gestión de tráfico del usuario', href: null },
    { title: 'Guía de seguridad en la red para usuarios', href: null },
    { title: 'Control parental', href: null },
    { title: 'Sistema de políticas y gestión de seguridad de la red', href: null },
    { title: 'Condiciones de calidad del servicio de internet', href: null },
  ];
