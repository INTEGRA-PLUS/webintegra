...
export const PLAN_GROUPS = {
  ...
  empresa: {
    ...
    plans: [
      {
        name: 'Plan Empresarial 100',
        tagline: 'Ideal para oficinas y negocios pequeños',
        speed: '100',
        unit: 'MEGAS',
        tv: 'TV Básico gratis',
        price: '100.000',
      ...
      {
        name: 'Plan Empresarial 200',
        tagline: 'El más elegido por las empresas',
        speed: '200',
        unit: 'MEGAS',
        tv: 'TV Básico gratis',
        price: '150.000',
      ...
      {
        name: 'Plan Empresarial 300',
        tagline: 'Para equipos que no se pueden detener',
        speed: '300',
        unit: 'MEGAS',
        tv: 'TV Básico+ gratis',
        price: '200.000',
      ...
      {
        name: 'Plan Empresarial 500',
        tagline: 'Máxima velocidad para tu operación',
        speed: '500',
        unit: 'MEGAS',
        tv: 'TV Básico+ gratis',
        price: '250.000',
