...
import { Check, Tv, ArrowRight, Star } from 'lucide-react';
import { WHATSAPP_URL } from './data/tv';

/**
 * TvPlanCard - Tarjeta de paquete de televisión.
 * El plan `popular` se resalta con borde rojo, escala y badge.
 *
 * @param {Object} plan - { name, tagline, channels, price, period, popular, features[] }
 */
export default function TvPlanCard({ plan }) {
