  ...
  return (
    <div className="animate-[fadeIn_0.5s_ease]">
      <div className="flex flex-col items-center text-center">
        <span className="mb-3 inline-flex items-center gap-2 rounded-full bg-tevesat-primary/10 px-4 py-1.5 text-xs font-black uppercase tracking-[0.25em] text-tevesat-primary-deep">
        ...
        <div className="my-4 flex items-end justify-center gap-2">
          ...
          <span className="mb-3 text-2xl font-black text-tevesat-primary-deep">Mbps</span>
        </div>
        ...
        <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-gray-100 bg-white px-4 py-1.5 text-xs font-black uppercase tracking-widest text-gray-500 shadow-sm">
          {TechIcon && <TechIcon size={14} className="text-tevesat-primary-deep" />}
          {recommendation.technology}
        </div>

        <h3 className="text-2xl font-black tracking-tight text-tevesat-primary-deep md:text-3xl">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          {recommendation.perks.map((perk) => (
            ...
            >
              <Check size={15} className="text-tevesat-primary-deep" strokeWidth={3} />
              {perk}
            </div>
          ))}
        </div>
        ...
        <div className="mt-10 flex w-full flex-col gap-3 sm:flex-row sm:justify-center">
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 rounded-2xl border-2 border-gray-200 bg-white px-8 py-4 font-black uppercase tracking-widest text-tevesat-tertiary-dark transition-all duration-300 hover:border-tevesat-primary hover:text-tevesat-primary-deep"
          >
