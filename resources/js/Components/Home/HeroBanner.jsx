  ...
  return (
    <section id="inicio" className="relative h-screen flex items-center justify-start overflow-hidden pt-16">
      ...
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-velonet-purple via-velonet-purple/60 to-transparent"></div>
        <div className="absolute inset-0 bg-gradient-to-t from-velonet-purple/80 via-transparent to-velonet-purple/20"></div>
      </div>
      ...
      <div className="relative z-10 text-left px-4 md:px-16 lg:px-24 max-w-5xl">
        <div className="inline-block bg-white/10 backdrop-blur-md px-4 py-1 rounded-full border border-white/20 mb-6 animate-fadeIn">
          <span className="text-velonet-orange font-black uppercase text-xs tracking-[0.2em]">Más cobertura, más diversión</span>
        </div>
        
        <h1 className="text-5xl md:text-8xl font-black text-white mb-6 leading-[0.9] animate-fadeIn">
          VIVE EL<br />
          <span className="text-velonet-orange">PODER DEL</span><br />
          WI-FI 6
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-6 animate-fadeIn" style={{ animationDelay: '0.4s' }}>
          <button className="bg-velonet-orange text-velonet-purple px-10 py-5 rounded-2xl font-black uppercase tracking-wider hover:bg-white hover:scale-105 transition-all duration-300 shadow-2xl shadow-velonet-orange/30">
            Me interesa
          </button>
        ...
        <div className="absolute bottom-10 right-10 animate-vertical-bounce hidden lg:block">
          <div className="w-8 h-12 rounded-full border-2 border-white/30 flex justify-center p-2">
            <div className="w-1 h-3 bg-velonet-orange rounded-full"></div>
          </div>
        </div>
      </div>
