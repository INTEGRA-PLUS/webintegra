...
export default function TvSection() {
  return (
    <section className="bg-white relative overflow-hidden py-16 md:py-0">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-1/2 left-0 w-full h-1 bg-gradient-to-r from-transparent via-tevesat-primary/20 to-transparent -rotate-12 blur-sm"></div>
        <div className="absolute top-1/3 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-tevesat-primary/30 to-transparent rotate-6"></div>
      </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="flex items-center gap-4 bg-white px-6 py-4 rounded-2xl border border-gray-200 shadow-sm">
               ...
               <div className="flex flex-col">
                  ...
                  <span className="text-tevesat-tertiary-dark text-lg font-black italic leading-none">GOFLEX</span>
               </div>
            </div>
          </div>
        </div>
        ...
        <div className="md:w-1/2 relative mt-12 md:mt-0 flex justify-center md:justify-end">
          <div className="relative w-full max-w-[600px] transform hover:scale-[1.03] transition-transform duration-1000">
            ...
            <img
              ...
              className="w-full h-auto rounded-[3.5rem] shadow-[0_40px_90px_-30px_rgba(0,0,0,0.3)] border-4 border-white"
            />
          </div>
        </div>
      </div>
