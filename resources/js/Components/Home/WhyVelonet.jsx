...
export default function WhyTevesat() {
  ...
  return (
    <section id="quienes-somos" className="py-24 md:py-32 px-4 md:px-8 bg-[#F4F7FA] relative overflow-hidden">
      ...
      <div className="absolute top-0 -left-20 w-96 h-96 bg-velonet-purple/5 rounded-full blur-[100px] pointer-events-none"></div>
      <div className="absolute bottom-0 -right-20 w-96 h-96 bg-velonet-orange/5 rounded-full blur-[100px] pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-20 relative z-10">
        ...
        <div className="lg:w-1/2">
          ...
          <div className="mb-16">
            <div className="flex items-center gap-2 mb-6">
              <div className="h-px w-8 bg-velonet-orange"></div>
              <span className="text-velonet-orange font-black uppercase text-[10px] tracking-[0.3em]">Beneficios Redes Tevesat S.A.S</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-black text-velonet-purple mb-8 leading-[1.1] tracking-tight">
              Conéctate con la red que <span className="text-velonet-orange">potencia</span> tu vida
            </h2>
            <p className="text-gray-500 text-lg font-medium leading-relaxed max-w-xl border-l-4 border-velonet-orange/20 pl-6">
        ...
        <div className="lg:w-1/2 relative group">
          <div className="absolute -top-10 -right-10 w-full h-full border-2 border-velonet-purple/10 rounded-[4rem] -z-10 group-hover:translate-x-4 group-hover:-translate-y-4 transition-transform duration-700"></div>
          ...
          <div className="rounded-[4rem] overflow-hidden shadow-[0_50px_100px_rgba(0,0,0,0.1)] border-8 border-white relative">
             ...
             <div className="absolute bottom-10 left-10 bg-white/90 backdrop-blur-md p-6 rounded-3xl shadow-2xl flex items-center gap-4 animate-bounce-slow">
                <div className="w-12 h-12 bg-velonet-orange rounded-xl flex items-center justify-center text-white font-black text-xl italic">
                  100%
                </div>
                <div>
                   <p className="text-velonet-purple font-black text-xs uppercase tracking-widest">Tecnología</p>
                   <p className="text-velonet-orange font-black text-lg leading-none">FIBRA ÓPTICA</p>
                </div>
             </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-24 px-4">
         <div className="relative rounded-[3.5rem] bg-velonet-purple p-12 md:p-16 shadow-[0_50px_100px_rgba(89,37,130,0.3)] overflow-hidden">
            {/* Background glowing accents */}
            <div className="absolute top-0 right-0 w-96 h-96 bg-velonet-orange/10 rounded-full blur-[100px] -mr-48 -mt-48"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10 divide-y md:divide-y-0 md:divide-x divide-white/10">
               <div className="pb-12 md:pb-0 text-center animate-fade-in">
                 <p className="text-6xl md:text-7xl font-black text-velonet-orange mb-4 tracking-tighter drop-shadow-[0_0_20px_rgba(255,170,0,0.4)]">
                   +50K
                 </p>
               ...
               <div className="py-12 md:py-0 md:px-12 text-center">
                 <p className="text-6xl md:text-7xl font-black text-white mb-4 tracking-tighter shadow-white/10 group-hover:text-velonet-orange transition-colors">
                   99.9%
                 </p>
