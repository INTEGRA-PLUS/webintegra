      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-3/5 w-full">
            <div className="bg-white rounded-[3rem] shadow-[0_40px_90px_-30px_rgba(0,0,0,0.25)] border border-gray-100 p-8 md:p-10 relative overflow-hidden">
              {/* Form Accent */}
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-1">
                      <label className="text-[10px] font-black uppercase tracking-widest text-gray-400 ml-1">Municipio</label>
                      <input
                        type="text"
                        name="municipio"
                  ...
                  <div className="space-y-1">
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows="2"
                      className="w-full px-5 py-4 bg-gray-50 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-tevesat-primary/30 focus:border-tevesat-primary text-tevesat-tertiary-dark font-bold transition-all text-sm resize-none placeholder-gray-400"
