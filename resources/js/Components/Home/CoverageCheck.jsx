    ...
    <section ref={sectionRef} id="cobertura" className="py-20 bg-white relative overflow-hidden px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div
            className="rounded-[2.5rem] p-10 md:p-14 relative bg-gradient-to-br from-tevesat-primary to-tevesat-primary-light overflow-hidden shadow-[0_40px_90px_-30px_rgba(127,171,60,0.5)]"
          >
            {/* Glow effect */}
