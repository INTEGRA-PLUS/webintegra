...
export default function MyPayment() {
  ...
  return (
    <section id="mi-pago" className="py-24 md:py-32 px-4 md:px-8 bg-white relative overflow-hidden">
      {/* Background patterns */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <a 
            ...
            className="group flex flex-col bg-white p-8 rounded-[3.5rem] border border-gray-100 shadow-[0_30px_70px_-30px_rgba(0,0,0,0.2)] hover:border-tevesat-primary hover:-translate-y-3 transition-all duration-500 text-center"
          >
            <div className="w-full aspect-square bg-gray-50 rounded-[2.5rem] flex items-center justify-center mb-8 group-hover:bg-tevesat-primary/10 transition-colors">
          ...
          {physicalPayments.map((p) => (
            <div 
              key={p.name}
              className="group flex flex-col bg-white p-8 rounded-[3.5rem] border border-gray-100 shadow-[0_30px_70px_-30px_rgba(0,0,0,0.2)] transition-all duration-500 text-center"
            >
              <div className="w-full aspect-square bg-gray-50 rounded-[2.5rem] flex items-center justify-center mb-8 border border-gray-100">
                 <img src={p.image} alt={p.name} className="w-[85%] h-[85%] object-contain group-hover:scale-110 transition-transform duration-500" />
              </div>
              <h3 className="text-xl font-black text-tevesat-tertiary-dark mb-4 leading-tight">{p.name}</h3>
        ...
        <div className="mt-20 text-center">
            <p className="text-gray-400 font-bold text-sm flex items-center justify-center gap-3 italic uppercase tracking-widest">
